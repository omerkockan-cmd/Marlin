...
/**
 * WiFi ve Web Arayüz Desteği
 */
#define ESP3D_WIFI_SUPPORT
#define WEBSUPPORT
#define ESP32_WIFI
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #endif
  #define LCD_SERIAL Serial2  // Hata veren 'LCD_SERIAL'ı burada tanımlıyoruz
  #define LCD_BAUDRATE 115200
  #define ENCODER_PHASE_0 0
  #define ENCODER_PHASE_1 1
  #define ENCODER_PHASE_2 2
  #define ENCODER_PHASE_3 3
#endif
#if HAS_DISPLAY
